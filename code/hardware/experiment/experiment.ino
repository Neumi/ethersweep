...
void loop() {
  ...
  if (jobDone == false) {
    String returnBuffer = packetBuffer;
    ...
    String raw_reply = root["reply"];
    raw_reply = root["reply"].as<String>();
